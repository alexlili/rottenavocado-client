...
import { createBornToday } from "../graphql/mutations";
const client = generateClient();
export default function BornTodayCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBornToday.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BornTodayCreateForm")}
      {...rest}
    >
      <TextField
        label="Avatar image"
