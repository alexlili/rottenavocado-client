...
import { createUpNextMedia } from "../graphql/mutations";
const client = generateClient();
export default function UpNextMediaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUpNextMedia.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UpNextMediaCreateForm")}
      {...rest}
    >
      <TextField
        label="Cover image"
