        ...
        >
          <div>
            ...
            <div style={{ padding: "25px 0" }}>
              ...
              <TwitterOutlined style={{ fontSize: 28, padding: "0 20px" }} />
              <InstagramOutlined style={{ fontSize: 28, padding: "0 20px" }} />
              <YoutubeOutlined style={{ fontSize: 28, padding: "0 20px" }} />
              <FacebookOutlined style={{ fontSize: 28, padding: "0 20px" }} />
            </div>
            <Flex
              wrap="wrap"
              gap="small"
            ...
            <div style={{ color: "rgba(255,255,255,0.7)", padding: "30px 0" }}>
              © 1990-2024 by rottenavocado.com, Inc.
            </div>
          </div>
        </Footer>
      </Layout>
